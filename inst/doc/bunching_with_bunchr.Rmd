...
is 0.2 (_elas_ = 0.2). The simulationincludes a kink at the earning point of 1000
...
the user. In this case, however, plotting is supressed.
...
manually. Howerver, this means that not all bunching comes from inside the notch.
