...
__NEW (Dec. 2016)!__ Explore bunching simulations in an interactive interface, using the _bunchrApp_. After loading the _bunchr_, run \code{bunch_sim} and start playing.
