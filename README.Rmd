...
Friedman, Olsen, and Pistaferry (see vignette). I am happy to to get comments
...
__Kinks__ and __notches__ create opportunities to measure the earning elasticity
w.r.t the net-of-tax rate. This parameter is considered sufficient statistic for calculating welfare from changes in tax regimes and welfare programs, and could
also be used to devise optimal tax rates.
