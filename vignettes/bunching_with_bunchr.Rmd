...
__NEW (Dec. 2016)!__ Explore bunching simulations in an interactive interface, using the _bunchrApp_. After loading _bunchr_, run `bunchApp()` and start playing.
