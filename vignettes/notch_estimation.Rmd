...
notch analysis. It closely follows the discussion by Kleven^[Kleven, H.J., 2016.
  _"Bunching"_, Annual Review of Economics 8(1)].
...
is $z^* = n^* \cdot (1-t_1)^e$.
There is another agent, the _marginal buncher_, with ability
...
$z^* + \Delta z^*$. The _marginal buncher is indifferent between two bundles, as
the budget line is not convex.
